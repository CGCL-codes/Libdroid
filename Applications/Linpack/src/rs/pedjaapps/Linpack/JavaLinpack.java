...
public class JavaLinpack {

	private int matrix_n = 500;

	public JavaLinpack(int n) {
		this.matrix_n = n;
	}
	...
	public Result run_benchmark() {
		...
		mflops_result = (long) (mflops_result * 1000);
		mflops_result /= 1000;

		Result result = new Result();
		result.mflops = mflops_result;
		result.time = time_result;
		result.nres = residn_result;
		result.precision = eps_result;
