...
public class Book {
    ...
    public Book(boolean verbose, Context mcontext) {
    ...
    private final void initBook() {
        ...
        numBookMoves = 0;
        try {
            InputStream inStream = new FileInputStream("/mnt/sdcard/thinkAir/book.bin");
        	//InputStream inStream = context.getResources().getAssets().open("book.bin");
