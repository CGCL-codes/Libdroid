...
public class ChessController {
    ...
    String thinkingPV;
    String strToast;
    ExecutionController excutionController = null;
    ...
    class SearchListener implements Search.Listener {
        ...
        public void notifyTimeCost(String str){
        	final String tempstr = str;
        	 gui.runOnUIThread(new Runnable() {
                 public void run() {
        			 strToast = tempstr;
                     //set computer thinking string
                     gui.setToast(tempstr);
                 }
             });
        }
    }
    ...
    public ChessController(Context context, ExecutionController controller) {
        this.excutionController = controller;
    	this.context = context;
        this.gui = (GUIInterface) context;
    ...
    public final void newGame(boolean humanIsWhite, int ttLogSize, boolean verbose, boolean auto) {
        ...
        computerPlayer = new ComputerPlayer(context,excutionController);
